...
Logos (c) 2009-2010 Open Icon Library, http://openiconlibrary.sourceforge.net/, released under CC BY-SA 3.0 license http://creativecommons.org/licenses/by-sa/3.0/
...
Development of this application was inspired by a response to one of my StackOverflow questions from Stefan Küng, lead developer of TortoiseSVN.


== Links

* Blog post on Radiotherapy.NET http://cureos.blogspot.com
